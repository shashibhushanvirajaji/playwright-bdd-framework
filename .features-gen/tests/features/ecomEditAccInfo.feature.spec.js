...
test.describe('Verify E-commerce Account Information Edit Functionality', () => {
  ...
  test('Successful Login with Valid Credentials', async ({ Given, When, Then, And, ecomEditAccountPage, ecomLoginPage }) => { 
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":6,"pickleLine":9,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":10,"keywordType":"Context","textWithKeyword":"Given the user is on the e-commerce login page 'https://ecommerce-playground.lambdatest.io/'","stepMatchArguments":[{"group":{"start":41,"value":"'https://ecommerce-playground.lambdatest.io/'","children":[{"children":[{"children":[]}]},{"start":42,"value":"https://ecommerce-playground.lambdatest.io/","children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":8,"gherkinStepLine":11,"keywordType":"Action","textWithKeyword":"When the user clicks on My Account link","stepMatchArguments":[]},{"pwStepLine":9,"gherkinStepLine":12,"keywordType":"Action","textWithKeyword":"And the user enters a valid email address \"shashi.virajaji@gmail.com\"","stepMatchArguments":[{"group":{"start":38,"value":"\"shashi.virajaji@gmail.com\"","children":[{"start":39,"value":"shashi.virajaji@gmail.com","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":10,"gherkinStepLine":13,"keywordType":"Action","textWithKeyword":"And the user enters a valid password \"Sbhushan@123\"","stepMatchArguments":[{"group":{"start":33,"value":"\"Sbhushan@123\"","children":[{"start":34,"value":"Sbhushan@123","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":11,"gherkinStepLine":14,"keywordType":"Action","textWithKeyword":"And the user clicks the login button","stepMatchArguments":[]},{"pwStepLine":12,"gherkinStepLine":15,"keywordType":"Outcome","textWithKeyword":"Then the user should be redirected to the homepage","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":16,"keywordType":"Outcome","textWithKeyword":"And the user navigates to Account Information page","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":17,"keywordType":"Action","textWithKeyword":"When the user updates the first name to \"ShashiUpdated\"","stepMatchArguments":[{"group":{"start":35,"value":"\"ShashiUpdated\"","children":[{"start":36,"value":"ShashiUpdated","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":15,"gherkinStepLine":18,"keywordType":"Action","textWithKeyword":"And the user updates the last name to \"VirajajiUpdated\"","stepMatchArguments":[{"group":{"start":34,"value":"\"VirajajiUpdated\"","children":[{"start":35,"value":"VirajajiUpdated","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":16,"gherkinStepLine":19,"keywordType":"Action","textWithKeyword":"And the user clicks on continue button to save changes","stepMatchArguments":[]},{"pwStepLine":17,"gherkinStepLine":20,"keywordType":"Outcome","textWithKeyword":"Then the user should see a success message indicating the account information has been updated successfully.","stepMatchArguments":[]}]},
]; // bdd-data-end